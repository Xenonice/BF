...
_G.Color = Color3.fromRGB(178, 102, 255) ---Color

local Star = StarHub:Window("Kamua Hub - Free Scripts")

local StarServer = Star:Server("KAMUA HUB",7040391851)
...
function UpdateTime()
    ...
    Time:Refresh("Hrs : "..Hour.." Min : "..Minute.." Sec : "..Second)
end
...
local ScreenGui = Instance.new("ScreenGui")
	...
	TextLabel.TextStrokeTransparency = 200.000
	...
	local function UpdateTime()
		...
		local Minute = math.floor(GameTime/(60^1))%60
		local Second = math.floor(GameTime/(60^0))%60
		TextLabel.Text = ("Hrs : "..Hour.." Min : "..Minute.." Sec : "..Second)
	end
...
AutoFarm:Toggle("Show Server-Time",true,function(value)
	ServerTime = value
...
AutoFarm:Toggle("Fast Attack", true, function(value)
    ...
    if game:GetService("CoreGui"):FindFirstChild("MUKURO GUI"):Destroy() then
    end
end)
...
Config:Label("K A M U A H U B  | C O N F I G")
...
local More = StarServer:Channel("New - Fix")

More:Label("Fix Bug Script")
More:Label("Fix Fast Attack")
More:Label("Fix Bring-Monster")
