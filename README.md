if game.PlaceId == 2753915549 or game.PlaceId == 4442272183 or game.PlaceId == 7449423635 then
        ...
        game.Players.LocalPlayer:kick("สคริปต์ไม่ซัพพอร์ตแมพนี้ค่ะ")
    end
    ...
    --------------------------------------------------------------------
    local RenUi = library:AddWindow("Kamua Hub | BF",Enum.KeyCode.RightControl)
    --------------------------------------------------------------------
        ...
        pcall(function()
            while wait() do
                if _G.Attk1 then
                    ...
                    ez.activeController.timeToNextAttack = 0
                    ez.activeController.timeToNextAttack = 0
                    ez.activeController.increment = 3
    ...
    Combat:AddToggle("Fast Attack for (PVP)",false,function(value)
        _G.Attk2 = value
    end)
        ...
        pcall(function()
            while wait() do
                if _G.Attk2 then
                    ...
                    ez.activeController.timeToNextAttack = 0
                    ez.activeController.timeToNextAttack = 0
                    ez.activeController.increment = 1
                    ez.activeController.hitboxMagnitude = 120
                end
            end
        end)
    ...
    Combat:AddToggle("WalkSpeed",function(value)
        _G.WalkSpeed = value
    end)

    Combat:AddSlider("Jump Power", 0,80,50, function(t)
        game:GetService("Players").LocalPlayer.Character.Humanoid.JumpPower = t
    end)

    Combat:AddSlider("Gravity", 0,500,196, function(t)
        workspace.Gravity = t
    end)
